...
function onElectronFolderSelected(data) {
    ...
    let strIconPath = "https://gateway.pinata.cloud/ipfs/QmRcRBcH8je2xk1j6DD7gGXLwyxeZmLLptY8Vsne44YSW2";

    if (data.bIncludeSubfolders) {
        strIconPath = "https://gateway.pinata.cloud/ipfs/Qma6M8rcff4P8GLEbgiTrGT9Kz2ab3siBeLUmAmhXWA4of";
    }
    ...
    buttonCancel.setAttribute("src", "https://gateway.pinata.cloud/ipfs/QmXDnKVwexxbpReTBFUzX8htgWugSjJGmqCknP3ACnw8F4");
